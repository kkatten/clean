            ...
            [
                ...
                'blocks' => [
                    ...
                    'why_us' => [
                        'title' => 'Почему мы',
                        'items' => [
                            ['title' => 'Цех по стирке ковров', 'description' => 'Стирка ковров и ковролина на профессиональном оборудовании.'],
                            ['title' => 'Производство и обслуживание входных ковров', 'description' => 'Изготовление и регулярная чистка входных зон.'],
                            ['title' => 'Оборудование для мойки фасадов до 16 м', 'description' => 'Промывка витрин и фасадов, промышленные альпинисты.'],
                            ['title' => 'Химчистка мебели', 'description' => 'Чистка диванов, кресел, ковров профессиональными средствами.'],
                            ['title' => 'Грязезащитные покрытия (аренда / продажа)', 'description' => 'Входные коврики, снижение износа полов.'],
                        ],
                    ],
                    'for_who' => [
